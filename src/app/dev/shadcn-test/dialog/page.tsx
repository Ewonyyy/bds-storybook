  ...
  return (
    <div className="flex flex-col gap-10">
      <section className="flex flex-col gap-3">
        <h2 className="text-sm text-muted-foreground">Open Dialog (기본형)</h2>
        <Dialog>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-sm text-muted-foreground">Sticky Footer</h2>
        <Dialog>
          <DialogTrigger render={<Button variant="outline" />}>
            Sticky Footer
          </DialogTrigger>
      ...
      <section className="flex flex-col gap-3">
        <h2 className="text-sm text-muted-foreground">Scrollable Content</h2>
        <Dialog>
          <DialogTrigger render={<Button variant="outline" />}>
            Scrollable Content
          </DialogTrigger>
